...
|```<not_listed_character [name]>```|The tag is used to indicate dramatic characters who appear in the play <br>but are not listed in the list of dramatic characters.|```<not_listed_character КАТЯ>```
