...
|```<not_listed_character [name]>```|The tag is used to indicate dramatic characters who appear <br>in the play but are not listed in the list of dramatic characters.|```<not_listed_character КАТЯ>```
